...
const AddressBlock = ({ addressBalance, label, currencyName, blvPrice, privateKey, fetchAndSetSinglePrivKey }) => {
      ...
      <AccordionItemPanel className={[styles.receiveDetail].join(' ')}>
        <div className={[cstyles.flexspacebetween].join(' ')}>
          <div className={[cstyles.verticalflex, cstyles.marginleft].join(' ')}>
            ...
            <div className={[cstyles.padtopsmall].join(' ')}>{Utils.getBlvToUsdString(blvPrice, balance)}</div>
