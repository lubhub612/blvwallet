...
const ToAddrBox = ({
  ...
  const usdValue = Utils.getBlvToUsdString(blvPrice, toaddr.amount);
...
const ConfirmModalToAddr = ({ toaddr, info }) => {
  const { bigPart, smallPart } = Utils.splitBlvAmountIntoBigSmall(toaddr.amount);
        ...
        <div className={[cstyles.verticalflex, cstyles.right].join(' ')}>
          <div className={cstyles.large}>
            <div>
              ...
              <span className={[cstyles.small, styles.blvsmallpart].join(' ')}>{smallPart}</span>
            </div>
          </div>
          <div>{Utils.getBlvToUsdString(info.blvPrice, toaddr.amount)}</div>
        </div>
      </div>
...
const ConfirmModalInternal = ({
  ...
  const { bigPart, smallPart } = Utils.splitBlvAmountIntoBigSmall(sendingTotal);
        ...
        <div className={cstyles.flex}>
          ...
          >
            ...
            <div className={[cstyles.right, cstyles.verticalflex].join(' ')}>
              ...
              <div className={cstyles.normal}>{Utils.getBlvToUsdString(info.blvPrice, sendingTotal)}</div>
            </div>
          </div>
        </div>
