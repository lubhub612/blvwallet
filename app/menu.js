...
export default class MenuBuilder {
  ...
  buildDarwinTemplate() {
    ...
    const subMenuAbout = {
      label: 'Blvwallet Fullnode',
      submenu: [
        {
          label: 'About Blvwallet Fullnode',
    ...
    const subMenuViewDev = {
      ...
      submenu: [
        ...
        {
          label: 'bitcoinloved info',
          click: () => {
            this.mainWindow.webContents.send('bitcoinloved');
          }
        },
        { type: 'separator' },
        {
    ...
    const subMenuHelp = {
      ...
      submenu: [
        ...
        },
        {
          ...
          click() {
            shell.openExternal('https://github.com/bitcoinlovefoundation/blvwallet/releases');
          }
        },
        {
          label: 'File a bug...',
          click() {
            shell.openExternal('https://github.com/bitcoinlovefoundation/blvwallet/issues');
          }
        }
      ]
    };
